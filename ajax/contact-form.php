...
// email address used as sender address
// it should be an email address which really exists on domain where you are hosting this site
// optionally you may leave it blank so the real sender email address will be used (the one entered in front-end form), but it may not work on some hosts
...
if( isset( $_REQUEST['contact-form'] ) ) {
    ...
    $email_from = !isset( $email_from ) || $email_from === '' ? $field_email : $email_from;
